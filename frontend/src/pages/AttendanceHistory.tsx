  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0">
        <h1 className="text-2xl sm:text-3xl font-bold text-slate-100">Attendance History</h1>
        <button
          ...
          <>
                ...
                <div key={log.id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <p className="font-medium text-slate-100">{formatDate(log.log_date)}</p>
                    </div>
                    <div>
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="font-medium text-slate-100">{formatDuration(log.duration)}</p>
                    </div>
                  </div>
                </div>
              ))}
            ...
            {totalPages > 1 && (
              <div className="flex flex-col sm:flex-row justify-between items-center gap-3 mt-4 sm:mt-6 pt-4 border-t">
                <div className="text-xs sm:text-sm text-slate-200 order-2 sm:order-1">
